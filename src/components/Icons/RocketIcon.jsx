function RocketIcon(props) {
  return (
    <svg width={128} height={128} xmlns="http://www.w3.org/2000/svg" {...props}>
      <linearGradient
        id="a"
        gradientTransform="matrix(-1 0 0 1 128.463 0)"
      ...
      <linearGradient
        ...
        y2={109.2064}
      >
        <stop offset={0.004447477} stopColor="#c62828" />
      ...
      <path
        d="M24.65 93.29c-5.15 5.15-5.43 14.53-5.43 14.53s9.38-.28 14.53-5.43c5.15-5.15 7.29-11.37 4.77-13.88s-8.71-.38-13.87 4.78z"
        fill="url(#b)"
      />
      <path
      ...
      <ellipse
        ...
        rx={8.9}
        ry={8.9}
        transform="rotate(-45.001 78.798 47.183)"
        fill="#455a64"
      />
      <path
        d="M78.8 40.28c1.84 0 3.58.72 4.88 2.02 1.3 1.3 2.02 3.04 2.02 4.88s-.72 3.58-2.02 4.88a6.87 6.87 0 01-4.88 2.02 6.87 6.87 0 01-4.88-2.02c-2.69-2.69-2.69-7.07 0-9.76 1.3-1.3 3.03-2.02 4.88-2.02m0-2c-2.28 0-4.56.87-6.3 2.61a8.896 8.896 0 000 12.59 8.882 8.882 0 006.3 2.61c2.28 0 4.56-.87 6.3-2.61a8.896 8.896 0 000-12.59 8.882 8.882 0 00-6.3-2.61z"
        fill="#424242"
        opacity={0.2}
      />
      <ellipse
        ...
        rx={6.44}
        ry={6.44}
        transform="rotate(-45.001 60.444 66.666)"
        fill="#455a64"
      />
      <path
      ...
      <g opacity={0.2}>
        <path
          d="M60.44 62.23c1.19 0 2.3.46 3.14 1.3.84.84 1.3 1.95 1.3 3.14 0 1.19-.46 2.3-1.3 3.14s-1.95 1.3-3.14 1.3c-1.19 0-2.3-.46-3.14-1.3-.84-.84-1.3-1.95-1.3-3.14 0-1.19.46-2.3 1.3-3.14.85-.84 1.96-1.3 3.14-1.3m0-2c-1.65 0-3.29.63-4.55 1.89a6.44 6.44 0 000 9.1c1.26 1.26 2.9 1.89 4.55 1.89s3.29-.63 4.55-1.89a6.44 6.44 0 000-9.1 6.389 6.389 0 00-4.55-1.89z"
          fill="#424242"
        />
      </g>
    </svg>
